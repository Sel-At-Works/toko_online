...
$id = $_GET['id'] ?? null;
if (!$id) {
    die('ID penjual tidak ditemukan di URL');
}
...
<div class="w-full max-w-3xl bg-white rounded-3xl shadow-xl overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-teal-600 to-emerald-500 p-6 text-white">
        <h2 class="text-2xl font-bold">Detail Penjual</h2>
        <p class="text-sm opacity-90">Informasi lengkap akun penjual</p>
    </div>
    ...
    <div class="p-8">
        ...
        <div class="text-center mb-8">
            ...
            <span class="inline-block mt-2 px-4 py-1 rounded-full text-xs bg-emerald-100 text-emerald-700">
                Penjual Aktif
            </span>
        </div>
        ...
        <div class="flex justify-between mt-10">
            ...
            <a href="edit_penjual.php?id=<?= $data['id'] ?>"
